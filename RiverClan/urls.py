...
urlpatterns = [
    ...
    path('flash_cards/<slug:slug>/cards/', views.list_cards, name="list_cards"),
    path('flash_cards/<slug:slug>/add_card', views.add_card, name='add_card'),
    ...
    path('flash_cards/<slug:slug>/quiz', views.quiz, name="quiz"),
